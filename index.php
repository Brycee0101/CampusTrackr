  ...
  <body>
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="./forms/login.php"><i class="fas fa-user signin grow">Log in</i></a>
      </div>
    </nav>
    <!-- <h1>Hello, world!</h1> -->
    <main>
        ...
        <div class="row align-items-center container mx-auto py-5">
          ...
          <div class="text col-lg-6 col-md-6 col-12 w-75">
            ...
            <div class="shrink d-inline-block">
              <a class="learn-more" href="forms/register.php">Register Now!</a><br><br><br><br><br><br>
            </div>
          </div>
        </div>
      </section>
